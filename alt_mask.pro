...
; NAME: ALT_MASK.PRO
;
; USAGE: alt_mask, img, altmask, threshold=threshold, unipolar=unipolar
;
...
pro alt_mask, img, mask, threshold=threshold, $
...
if (n_elements(threshold) eq 0) then begin
    ...
    print,'% ALT_MASK: Using 1-sigma threshold of ', $
      string(threshold)
endif
...
; if necessary, laebl negatives
;==============================
if not(keyword_set(unipolar)) then begin
