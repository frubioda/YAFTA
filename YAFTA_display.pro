Pro	yafta_display, image, $ ; renamed version of DISPLAY.PRO, 03 May 2007
		xs, ys, $
...
;+
; NAME:
;	YAFTA_DISPLAY.PRO (fixed version of DISPLAY.PRO, for use with YAFTA)
;
; PURPOSE:
...
;
	...
	byte_im = Imgscl_Fen(im, Min=minval, Max=maxval, Top=!D.Table_Size-2, $
